...
import { useGetProductQuery, useCreateCartMutation, useGetCartQuery, useGetHighlightProductQuery } from '@/store/api'
...
const ProductPage = () => {
    ...
    const { data: highlight, isLoading: highlightLoading } = useGetHighlightProductQuery()
  ...
  return (
    <div className='min-h-[100%] w-full p-3 sm:p-5 bg-[#dde0e9] flex flex-col gap-3 sm:gap-5 overflow-y-auto'>
        ...
        <div className='w-full bg-[#f5f5f5] p-3 sm:p-5 shadow-lg rounded-lg relative'>
            ...
            <h1 className='text-sm sm:text-xl font-semibold text-zinc-600 mt-10'>Highlighted Products</h1>
