  ...
  return (
    <div className='flex flex-col w-full gap-3 sm:gap-5 h-full overflow-x-hidden'>
      ...
      <div className='w-full lg:h-full flex flex-col-reverse lg:flex-row gap-3 sm:gap-5 overflow-y-hidden'>
        <div className='lg:w-2/3 h-full w-full bg-[#f5f5f5] rounded-lg shadow-lg p-3 sm:p-5 flex flex-col gap-5 overflow-auto custom-scroll-bar'>
        <WaveChart chartData={finalDailySummary}/>
        <div className='flex gap-3 sm:gap-5 overflow-x-auto custom-scroll-bar2 flex-wrap'>
          ...
          <div className='bg-follow bg-opacity-10 p-3 sm:p-5 rounded-xl flex flex-col gap-5 max-w-60 flex-1 w-full'>
            <h1 className='text-follow text-xl font-semibold'>Sip in style, printed just for you.</h1>
          </div>
          <div className='bg-myYellow bg-opacity-10 p-3 sm:p-5 rounded-xl flex flex-col gap-5 max-w-60 flex-1 w-full'>
            <h1 className='text-myYellow text-xl font-semibold'>Wear your vibe, printed to perfection.</h1>
          </div>
          <div className='bg-main bg-opacity-10 p-3 sm:p-5 rounded-xl flex flex-col gap-5 max-w-60 flex-1 w-full'>
        ...
        <div className='lg:w-1/3 overflow-hidden h-full bg-[#f5f5f5] rounded-lg shadow-lg p-3 sm:p-5 flex flex-col justify-between'>
        ...
        <div className='flex flex-col justify-between'>
          <h1 className='bg-main px-1 sm:px-2 py-1 text-xs rounded-lg text-[#f5f5f5] w-fit'>{session?.user.role}</h1>
          <div className='flex flex-col'>
          <h1 className='text-sm sm:text-xl font-semibold text-zinc-800'>{session?.user.name}</h1>
          <h1 className='text-zinc-500 sm:text-base text-xs'>{session?.user.email}</h1>
          </div>
        </div>
        </div>
          <div className='grid grid-cols-1 xl:grid-cols-2 md:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-5 w-full mt-20'>
